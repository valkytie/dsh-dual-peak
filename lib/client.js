    ...
    function createDualPeakWidget(ctx) {
      return function DualPeakWidget() {
        ...
        const onDown = (e) => {
          ...
          // 不依賴 setPointerCapture（Safari 對 mouse 會拋 NotFoundError）：
          // 直接在 window 上監聽 move/up，跨瀏覽器最穩。
        ...
        const card = React.createElement('div', { className: 'dpk-card' },
          React.createElement('div', { className: 'dpk-head', onPointerDown: onDown, onPointerMove: onMove, onPointerUp: onUp, onPointerCancel: onUp },
